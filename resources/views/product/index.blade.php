                        ...
                        <div class="swiper-container gallery-thumbs-vertical col-2 pb-4">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide bg-light bg-light h-auto">
                                    <picture>
                                        <img class="img-fluid mx-auto d-table"
                                            src="assets/src/assets/images/products/product-5.jpg"
                                ...
                                <div class="swiper-slide bg-light bg-light h-auto">
                                    <picture>
                                        <img class="img-fluid mx-auto d-table"
                                            src="assets/src/assets/images/products/product-5b.jpg"
                                            alt="Bootstrap 5 Template by Pixel Rocket">
                                    </picture>
                                </div>
                                <div class="swiper-slide bg-light bg-light h-auto">
                                    <picture>
                                        <img class="img-fluid mx-auto d-table"
                                            src="assets/src/assets/images/products/product-5c.jpg"
                                            alt="Bootstrap 5 Template by Pixel Rocket">
                                    </picture>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                ...
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-2.jpg') }} alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
                                            class="small text-uppercase tracking-wide fw-bolder text-center d-block">Quick
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-4.jpg') }}"
                                            alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-5.jpg') }}"
                                            alt="">
                                    </picture>
                                    <picture class="position-absolute z-index-20 start-0 top-0 hover-show bg-light">
                                        <img class="w-100 img-fluid" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-5b.jpg') }}"
                                            alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-6.jpg') }}"
                                            alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                ...
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-7.jpg') }}"
                                            alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
                        ...
                        <div class="swiper-slide d-flex h-auto">
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                ...
                                <div class="card-header">
                                    <picture class="position-relative overflow-hidden d-block bg-light">
                                        <img class="w-100 img-fluid position-relative z-index-10" title=""
                                            src="{{ asset('assets/src/assets/images/products/product-8.jpg') }}"
                                            alt="">
                                    </picture>
                                    <div class="card-actions">
                                        <span
