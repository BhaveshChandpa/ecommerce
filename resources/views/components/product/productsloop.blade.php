        ...
        <div class="card position-relative h-100 card-listing hover-trigger">
            <div class="card-header">
                <picture class="position-relative overflow-hidden d-block bg-light">
                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="{{ $product->image }}"
                        alt="">
                </picture>
                ...
                <div class="card-actions">
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-wrap mt-3">
                        ...
                        <a href="{{ route('product.show', ['slug' => $product->slug, 'size' => $variant->name]) }}" class="btn btn-outline-dark btn-sm mx-2">
                            {{ $variant->name }}
                        </a>
                    @endforeach
                    </div>
            ...
            <div class="card-body px-0 text-center">
                ...
                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                    href="{{ route('product.show', ['slug' => $product->slug, 'size' => $size ?? null]) }}">{{ $product->name }}</a>
